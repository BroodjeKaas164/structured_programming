...
def insert(lst, grens, waarde):
    ...
    while True:
        for getal in range(grens, len(lst)):
            if waarde < lst[0]:
                lst[0], lst[lst.index(waarde)] = lst[lst.index(waarde)], lst[0]
            elif lst[lst.index(waarde) + 1] < waarde:
                lst[lst.index(waarde) + 1], lst[lst.index(waarde)] = lst[lst.index(waarde)], lst[lst.index(waarde) + 1]
        break
